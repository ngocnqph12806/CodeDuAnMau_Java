...
public class FormMain extends javax.swing.JFrame {
    ...
    private FormDoiMatKhau1 _FormDoiMatKhau1 = new FormDoiMatKhau1();
    private FormQuanLyNguoiHoc1 _FormQuanLyNguoiHoc1 = new FormQuanLyNguoiHoc1();
    private FormQuanLyChuyenDe1 _FormQuanLyChuyenDe1 = new FormQuanLyChuyenDe1();
    private FormQuanLyHocVien1 _FormQuanLyHocVien1 = new FormQuanLyHocVien1();
    private FormQuanLyKhoaHoc1 _FormQuanLyKhoaHoc1 = new FormQuanLyKhoaHoc1();
    private FormQuanLyNhanVien1 _FormQuanLyNhanVien1 = new FormQuanLyNhanVien1();
    private FormThongKe1 _FormThongKe1 = new FormThongKe1();
    ...
    private void initComponents() {
        ...
        lblHinhAnh.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/AnhBia1.png"))); // NOI18N
...
//            e.printStackTrace();
//        }
        _FormQuanLyKhoaHoc1.setVisible(!_FormQuanLyKhoaHoc1.isVisible());
        _FormQuanLyKhoaHoc1.setUpForm();
        lblHinhAnh.add(_FormQuanLyKhoaHoc1);
...
//            e.printStackTrace();
//        }
        _FormDoiMatKhau1.setVisible(!_FormDoiMatKhau1.isVisible());
        lblHinhAnh.add(_FormDoiMatKhau1);
//        if (_FormDoiMatKhau1.isVisible()) {
//            _FormDoiMatKhau1.setVisible(false);
//        } else {
//            _FormDoiMatKhau1 = new FormDoiMatKhau1();
//            _FormDoiMatKhau1.setVisible(true);
//            lblHinhAnh.add(_FormDoiMatKhau1);
//        }
...
//            e.printStackTrace();
//        }
        _FormQuanLyChuyenDe1.setVisible(!_FormQuanLyChuyenDe1.isVisible());
        _FormQuanLyChuyenDe1.setUpForm();
        lblHinhAnh.add(_FormQuanLyChuyenDe1);
//        if (_FormQuanLyChuyenDe1.isVisible()) {
//            _FormQuanLyChuyenDe1.setVisible(false);
//        } else {
//            _FormQuanLyChuyenDe1 = new FormQuanLyChuyenDe1();
//            _FormQuanLyChuyenDe1.setVisible(true);
//            lblHinhAnh.add(_FormQuanLyChuyenDe1);
//        }
...
//            e.printStackTrace();
//        }
        _FormQuanLyNguoiHoc1.setVisible(!_FormQuanLyNguoiHoc1.isVisible());
        _FormQuanLyNguoiHoc1.setUpForm();
        lblHinhAnh.add(_FormQuanLyNguoiHoc1);
//        if (_FormQuanLyNguoiHoc1.isVisible()) {
//            _FormQuanLyNguoiHoc1.setVisible(false);
//        } else {
//            _FormQuanLyNguoiHoc1 = new FormQuanLyNguoiHoc1();
//            _FormQuanLyNguoiHoc1.setVisible(true);
//            lblHinhAnh.add(_FormQuanLyNguoiHoc1);
//        }
...
//        }
        ...
        _FormQuanLyKhoaHoc1.setUpForm();
        lblHinhAnh.add(_FormQuanLyKhoaHoc1);
//        if (_FormQuanLyKhoaHoc1.isVisible()) {
//            _FormQuanLyKhoaHoc1.setVisible(false);
//        } else {
////            _FormQuanLyKhoaHoc1 = new FormQuanLyKhoaHoc1();
//            _FormQuanLyKhoaHoc1.setUpForm();
//            _FormQuanLyKhoaHoc1.setVisible(true);
//            lblHinhAnh.add(_FormQuanLyKhoaHoc1);
//        }
...
//            e.printStackTrace();
//        }
        _FormQuanLyHocVien1.setVisible(!_FormQuanLyHocVien1.isVisible());
        _FormQuanLyHocVien1.setUpForm();
        lblHinhAnh.add(_FormQuanLyHocVien1);
//        if (_FormQuanLyHocVien1.isVisible()) {
//            _FormQuanLyHocVien1.setVisible(false);
//        } else {
//            _FormQuanLyHocVien1 = new FormQuanLyHocVien1();
//            _FormQuanLyHocVien1.setVisible(true);
//            lblHinhAnh.add(_FormQuanLyHocVien1);
//        }
...
//            e.printStackTrace();
//        }
        _FormQuanLyNhanVien1.setVisible(!_FormQuanLyNhanVien1.isVisible());
        _FormQuanLyNhanVien1.setUpForm();
        lblHinhAnh.add(_FormQuanLyNhanVien1);
//        if (_FormQuanLyNhanVien1.isVisible()) {
//            _FormQuanLyNhanVien1.setVisible(false);
//        } else {
//            _FormQuanLyNhanVien1 = new FormQuanLyNhanVien1();
//            _FormQuanLyNhanVien1.setVisible(true);
//            lblHinhAnh.add(_FormQuanLyNhanVien1);
//        }
    ...
    int indexFormThongKe = -1;

    private void evtThongKe(int x) {
//        FormThongKe thongKe = new FormThongKe(x);
//        thongKe.setVisible(true);
//        _lstThongKes.add(thongKe);
        if (_FormThongKe1.isVisible() && indexFormThongKe == x) {
            _FormThongKe1.setVisible(false);
        } else if (indexFormThongKe != x) {
            _FormThongKe1.setVisible(false);
            _FormThongKe1 = new FormThongKe1(x);
            indexFormThongKe = x;
            _FormThongKe1.setVisible(true);
            lblHinhAnh.add(_FormThongKe1);
        } else {
            _FormThongKe1 = new FormThongKe1(x);
            indexFormThongKe = x;
            _FormThongKe1.setVisible(true);
